...
const Resize2 = () => (
  <Template
    ...
    description="Here are examples of responsive React components using the useState, useEffect and useRef hooks from React to calculate the percentage of an element currently in the viewport or in the case of the Growing image how far from the bottom of the screen the image is. Fela css allows for the easy responsive nature of the CSS properties. Throttling is in place on each of the hooks."
  >
